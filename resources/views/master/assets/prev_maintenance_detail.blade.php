                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input type="text" class="form-control form-control form-control-sm" placeholder="" value="Current Check">
                            </div>
                        </div>
                    </div>
                    <div class="col-6"></div>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group row">
                            ...
                            <div class="col-4">
                                <input type="text" class="form-control form-control form-control-sm text-right"  value="1000">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <textarea name="" id="" cols="30" rows="5" class="form-control form-control-sm">Pastikan arus listrik yang bekerja pada motor masih dibawah arus maksimal yang tertera pada nameplate motor.</textarea>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-4">
                                    <select name="" id=""
                                        ...
                                        <option value="" selected>Maintenance Bulanan</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <textarea name="" id="" cols="30" rows="5"
                                        class="form-control form-control-sm">Pastikan arus listrik yang bekerja pada motor masih dibawah arus maksimal yang tertera pada nameplate motor.</textarea>
                                </div>
                            </div>
                        </div>
