        ...
        <div class="card card-info card-outline">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control form-control form-control-sm"value="Unit Produksi 1">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control form-control form-control-sm"value="Unit 1/2">
                    </div>
                </div>
            </div>
