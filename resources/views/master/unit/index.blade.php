                ...
                <table id="data-table" class="table table-bordered table-striped table-hover nowrap">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('master.unit.detail') }}" class="btn btn-sm btn-default text-blue"><i class="fas fa-info-circle"></i> Detail</a>
                                    <a onclick="confirm('Yakin akan menghapus?')" class="btn btn-sm btn-default text-red"><i class="fas fa-trash"></i> Delete</a>
                                </div>

                            </td>
                            <td>Unit Produksi 1/2</td>
                            <td>Unit 1/2</td>
                        </tr>
                    </tbody>
                </table>
