    ...
    <div class="col-12">
        <div class="card card-info card-outline card-outline-tabs">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input type="text" class="form-control form-control form-control-sm" placeholder="" value="CO (128)">
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input type="text" class="form-control form-control form-control-sm reservationtime" placeholder="" value="16/11/2023 7:00 - 02/12/2023 7:00">
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
            ...
            <div class="card-footer">
                <a href="{{ route('operation.jadwal_prod.index') }}" class="btn btn-default">
