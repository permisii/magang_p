                            ...
                            <div class="col-8 select2-info">
                                <select class="select2" multiple="multiple" data-placeholder="Area yang terlibat" data-dropdown-css-class="select2-info" style="width: 100%;">
                                    <optgroup label="Unit Produksi 1 - Unit 1">
                                        <option>Stock Preparatin 1 - SP1</option>
                                        <option>Paper Machine 1 - PM1</option>

                                        <option>Stock Preparatin 2 - SP2</option>
                                        <option>Paper Machine 2 - PM2</option>
                                    </optgroup>

                                    <optgroup label="Unit Produksi 2 - Unit 2">
                                        <option>Stock Preparatin 3 - SP3</option>
                                        <option>Paper Machine 3 - PM3</option>

                                        <option>Stock Preparatin 5 - SP5</option>
                                        <option>Paper Machine 5 - PM5</option>
                                    </optgroup>
