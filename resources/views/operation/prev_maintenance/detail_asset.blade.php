    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-header">
                <span class="card-title">Subject : Asset</span>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input type="text" class="form-control form-control form-control-sm bg-gray-100" placeholder="" value="Overhaul" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group row">
                            ...
                            <div class="col-4">
                                <input type="text" class="form-control form-control form-control-sm bg-gray-100" placeholder="" value="360 Jam Lagi" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <textarea name="" id="" cols="30" rows="5" class="form-control form-control-sm" readonly>Pengantian sparepart berdasarkan habisnya masa lifetime
                                </textarea>
                            </div>
                        </div>
                    </div>
