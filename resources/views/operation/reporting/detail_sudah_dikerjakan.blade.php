...
Bersihkan mesin las dengan lap bersih dan kering. Hindari penggunaan bahan kimia abrasif atau bahan pembersih yang keras yang dapat merusak permukaan mesin las.

Periksa dan bersihkan kabel penghubung dan konektor secara teratur. Pastikan mereka tidak kendor atau rusak.
                            </textarea>
                        </div>
                    </div>
...
1. elco 400v 560mF (2 buah)
1. elco 400v 400mF (2 buah)
                            </textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="number" class="form-control form-control form-control-sm text-right"
                                min="0" max="100" placeholder="PERSENTASE" value="10" autocomplete="off" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <textarea class="form-control" rows="3" placeholder="KETERANGAN" readonly></textarea>
                        </div>
                    </div>
                    @endfor
